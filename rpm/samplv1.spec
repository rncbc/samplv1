...
%package -n %{name}-jack
Summary:	An old-school polyphonic sampler - JACK standalone
Provides:	%{name}_jack
...
%package -n %{name}-lv2
Summary:	An old-school polyphonic sampler - LV2 plugin
...
%changelog
* Thu Mar 24 2023 Rui Nuno Capela <rncbc@rncbc.org> 0.9.30
