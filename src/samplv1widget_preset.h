...
#ifndef __samplv1widget_preset_h
#define __samplv1widget_preset_h
...
class samplv1widget_preset : public QWidget
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	samplv1widget_preset(QWidget *pParent = nullptr);
	...
	void reloadPresets(samplv1_presets *pPresets = nullptr);
...
private:
	...
	samplv1widget_presets::ComboBox *m_pComboBox;
...
#endif  // __samplv1widget_preset_h

// end of samplv1widget_preset.h
