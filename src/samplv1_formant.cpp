...
//---------------------------------------------------------------------
// samplv1_formant - formant parallel filter after Dennis H. Klatt's
...
samplv1_formant::Vtab samplv1_formant::g_alto_vtab[NUM_VOWELS] = {
	// Table D.1. alto “a”
...
samplv1_formant::Vtab samplv1_formant::g_bass_vtab[NUM_VOWELS] = {
	// Table D.6. bass “a”
...
samplv1_formant::Vtab samplv1_formant::g_countertenor_vtab[NUM_VOWELS] = {
...
samplv1_formant::Vtab samplv1_formant::g_soprano_vtab[NUM_VOWELS] = {
...
samplv1_formant::Vtab samplv1_formant::g_tenor_vtab[NUM_VOWELS] = {
	// Table D.21. tenor “a”
...
// base vocal tables.
samplv1_formant::Vtab *samplv1_formant::g_vtabs[NUM_VTABS] = {
	g_bass_vtab,
	g_tenor_vtab,
	g_countertenor_vtab,
	g_soprano_vtab,
...
void samplv1_formant::Impl::vtab_coeffs (
...
// reset method impl.
void samplv1_formant::Impl::reset_coeffs ( float cutoff, float reso )
{
...
// reset method.
void samplv1_formant::reset_coeffs ( float cutoff, float reso )
{
	m_cutoff = cutoff;
	m_reso = reso;
