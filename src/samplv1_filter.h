...
#ifndef __samplv1_filter_h
#define __samplv1_filter_h
...
//-------------------------------------------------------------------------
// samplv1_filter1 - Hal Chamberlin's State Variable (12dB/oct) filter
//
...
//-------------------------------------------------------------------------
// samplv1_filter2 - Stilson/Smith Moog (24dB/oct) filter
//
...
//-------------------------------------------------------------------------
// samplv1_filter3 - RBJ biquad filter implementation.
//
//   http://www.musicdsp.org/files/Audio-EQ-Cookbook.txt

class samplv1_filter3
{
public:

	enum Type { Low = 0, Band, High, Notch };

	samplv1_filter3(Type type = Low)
