...
#ifndef __samplv1_tuning_h
#define __samplv1_tuning_h
...
class samplv1_tuning
{
public:

	// Default reference note and pitch (A4 @440hz)
	samplv1_tuning(float refPitch = 440.0f, int refNote = 69);
...
#endif	// __samplv1_tuning_h

// end of samplv1_tuning.h
