...
#ifndef __samplv1_formant_h
#define __samplv1_formant_h
...
class samplv1_formant
{
public:

	// ctor.
	samplv1_formant(float srate = 44100.0f)
		: m_srate(srate) { reset(); }
...
#endif	// __samplv1_formant_h

// end of samplv1_formant.h
