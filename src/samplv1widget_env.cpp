...
// Constructor.
samplv1widget_env::samplv1widget_env ( QWidget *pParent )
	: QFrame(pParent),
...
// Resize canvas.
void samplv1widget_env::resizeEvent ( QResizeEvent *pResizeEvent )
{
...
void samplv1widget_env::updatePolygon (void)
{
	const QRect& rect = QFrame::rect();
	const int h  = rect.height();
	const int w  = rect.width();
