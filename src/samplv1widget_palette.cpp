...
static const char *samplv1widget_paletteGroup = "/samplv1widget_palette/";
...
void samplv1widget_palette::nameComboActivated ( const QString& name )
{
	setPaletteName(name);
}
...
bool samplv1widget_palette::namedPalette ( const QString& name, QPalette& pal )
{
...
void samplv1widget_palette::saveNamedPalette (
...
void samplv1widget_palette::deleteNamedPalette ( const QString& name )
{
	if (m_settings) {
		m_settings->beginGroup(ColorThemesGroup);
...
QStringList samplv1widget_palette::namedPaletteList (void)
{
...
{
	if (m_settings) {
		m_settings->beginGroup(samplv1widget_paletteGroup);
