...
//-------------------------------------------------------------------------
// samplv1_fx_filter - RBJ filter implementation.
...
public:
	...
	samplv1_fx_comp(uint32_t iSampleRate = 44100)
	...
	void reset()
	{
		...
		// HOUSE eq.
		m_lo.reset(samplv1_fx_filter::Peak,      100.0f, m_srate, 1.0f, 6.0f);
		m_mi.reset(samplv1_fx_filter::LoShelf,  1000.0f, m_srate, 1.0f, 3.0f);
		m_hi.reset(samplv1_fx_filter::HiShelf, 10000.0f, m_srate, 1.0f, 4.0f);
	}
...
public:
	...
	samplv1_fx_chorus(uint32_t iSampleRate = 44100)
...
public:
	...
	samplv1_fx_delay(uint32_t iSampleRate = 44100)
...
public:
	...
	samplv1_fx_phaser(uint32_t iSampleRate = 44100)
		: m_srate(float(iSampleRate)) { reset(); }
