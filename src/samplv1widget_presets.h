...
#ifndef __samplv1widget_presets_h
#define __samplv1widget_presets_h
...
//----------------------------------------------------------------------------
// samplv1widget_presets -- Custom (tree) widget.

class samplv1widget_presets : public QTreeWidget
{
	Q_OBJECT
...
public:
	...
	// ctor.
	samplv1widget_presets(QWidget *pParent = nullptr);
	// dtor.
	~samplv1widget_presets();
...
// custom combo-box decl.
//
class samplv1widget_presets::ComboBox : public QComboBox
{
	Q_OBJECT
...
public:
	...
	samplv1widget_presets *presetsView() const;
...
private:
	...
	samplv1widget_presets *m_pPresetsView;
};


#endif	// __samplv1widget_presets_h

// end of samplv1widget_presets.h
