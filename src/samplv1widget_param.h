...
class samplv1widget_dial : public QDial
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	samplv1widget_dial(QWidget *pParent = 0);
...
class samplv1widget_knob : public samplv1widget_param
{
	Q_OBJECT
...
class samplv1widget_edit : public QDoubleSpinBox
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	samplv1widget_edit(QWidget *pParent = 0);
...
public:
	...
	// Constructor.
	samplv1widget_spin(QWidget *pParent = 0);
...
public:
	...
	// Constructor.
	samplv1widget_combo(QWidget *pParent = 0);
...
class samplv1widget_radio : public samplv1widget_param
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	samplv1widget_radio(QWidget *pParent = 0);
...
class samplv1widget_check : public samplv1widget_param
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	samplv1widget_check(QWidget *pParent = 0);
...
class samplv1widget_group : public QGroupBox
{
	Q_OBJECT
...
public:
	...
	// Constructor.
	samplv1widget_group(QWidget *pParent = 0);
