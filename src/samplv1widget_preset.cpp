...
//-------------------------------------------------------------------------
// samplv1widget_preset - Custom preset-box widget.
//
	...
	: QWidget(pParent)
{
	...
	m_pComboBox     = new samplv1widget_presets::ComboBox();
...
void samplv1widget_preset::activatePreset ( const QString& sPreset )
{
	...
	if (pPresetItem == nullptr && bankItem(sPreset))
...
bool samplv1widget_preset::isDirtyPreset (void) const
{
...
void samplv1widget_preset::setPresetItem ( const QString& sPreset )
{
...
QTreeWidgetItem *samplv1widget_preset::presetItem ( const QString& sPreset ) const
{
	return m_pPresetsView->presetItem(sPreset);
}


void samplv1widget_preset::setBankItem ( const QString& sBank, int iPreset )
{
	m_pPresetsView->setBankItem(sBank, iPreset);
}


QTreeWidgetItem *samplv1widget_preset::bankItem ( const QString& sBank ) const
{
	return m_pPresetsView->bankItem(sBank);
}
