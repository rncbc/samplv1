...
QString samplv1_config::presetsGroup (void)
{
	return "/Presets";
}

QString samplv1_config::presetsListKey (void)
{
	return "/PresetList";
}
...
void samplv1_config::importPresets (
	const QString& sFilename, samplv1_presets *pPresets )
{
...
void samplv1_config::loadPresets ( QSettings *pSettings,
	samplv1_presets *pPresets,	const MapPath& mapPath )
{
...
void samplv1_config::exportPresets (
	const QString& sFilename, samplv1_presets *pPresets )
{
	QSettings settings(sFilename, QSettings::IniFormat);
...
void samplv1_config::savePresets (
	QSettings *pSettings, samplv1_presets *pPresets, const MapPath& mapPath )
{
...
// Presets utility methods.
QString samplv1_config::presetsBanksGroup (void)
{
	return "/Banks";
}
...
QString samplv1_config::programsGroup (void)
{
	return "/Programs";
}

QString samplv1_config::bankPrefix (void)
{
	return "/Bank_";
}
...
// Programs utility methods.
QString samplv1_config::controlsGroup (void)
{
	return "/Controllers";
}

QString samplv1_config::controlPrefix (void)
{
	return "/Control";
}
