...
// Constructor.
samplv1widget_filt::samplv1widget_filt ( QWidget *pParent )
	: QFrame(pParent),
...
// Destructor.
samplv1widget_filt::~samplv1widget_filt (void)
{
}
...
float samplv1widget_filt::cutoff (void) const
{
	return m_fCutoff;
}
...
float samplv1widget_filt::reso (void) const
{
	return m_fReso;
}


void samplv1widget_filt::setType ( float fType )
{
...
float samplv1widget_filt::type (void) const
{
	return m_fType;
}


void samplv1widget_filt::setSlope ( float fSlope )
{
...
float samplv1widget_filt::slope (void) const
{
	return m_fSlope;
}
...
// Mouse interaction.
void samplv1widget_filt::mousePressEvent ( QMouseEvent *pMouseEvent )
{
...
void samplv1widget_filt::mouseMoveEvent ( QMouseEvent *pMouseEvent )
{
...
// Resize canvas.
void samplv1widget_filt::resizeEvent ( QResizeEvent *pResizeEvent )
{
...
void samplv1widget_filt::updatePath (void)
{
	const QRect& rect = QWidget::rect();
	const int h  = rect.height();
	const int w  = rect.width();
