...
bool samplv1_control::isPending (void) const
{
	return m_pImpl->is_pending();
}


bool samplv1_control::process ( const samplv1_control::Event& event )
{
	return m_pImpl->process(event);
}


bool samplv1_control::dequeue ( samplv1_control::Event& event )
{
